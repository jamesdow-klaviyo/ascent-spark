...
const modules = import.meta.glob<PrototypeModule>('../prototypes/*/index.tsx', { eager: true })

export const prototypeNames = Object.keys(modules)
  .map((k) => k.replace('../prototypes/', '').replace('/index.tsx', ''))
  .sort()
...
export function getPrototypeRoutes(): RouteObject[] {
  ...
  for (const name of prototypeNames) {
    const key = `../prototypes/${name}/index.tsx`
